...
# 模型拟合
reg = SVR(**opt.best_params_)

reg.fit(X_train, y_train)

joblib.dump(reg, 'SVR/SVR.pkl')
# 模型评估
...
plt.grid(True)
plt.tight_layout()
plt.savefig('SVR/SVR_train_set.png')
plt.close()
...
# plt.savefig('SVR_model/img2-100.png')
# plt.close()